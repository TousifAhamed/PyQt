...
# Form implementation generated from reading ui file 'truthtable.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboX.setGeometry(QtCore.QRect(80, 120, 291, 111))
        font = QtGui.QFont()
        ...
        self.comboY.setGeometry(QtCore.QRect(470, 120, 261, 101))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.submit.setGeometry(QtCore.QRect(280, 400, 291, 131))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.submit.setFont(font)
        self.submit.setObjectName("submit")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(280, 280, 281, 71))
        font = QtGui.QFont()
        font.setPointSize(22)
