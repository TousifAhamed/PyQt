...
# Objective of this sample project is to add some options on menu bar and link it with 
# status messages like if user is clicking on File -> New button status message has to be 
# shown like "New was clicked" 
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(260, 50, 351, 211))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNew.setWhatsThis(_translate("MainWindow", "Create a new file"))
